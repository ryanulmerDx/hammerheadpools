      ...
      <section className="py-section">
        <div className="mx-auto max-w-6xl px-6 grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-pool-deep via-pool-deep/80 to-transparent pt-20 pb-7 px-7">
              <div className="grid grid-cols-2 gap-5">
                {STATS.slice(0, 4).map((stat) => (
                  <div key={stat.label} className="text-center">
                    <div
                      className="text-3xl font-extrabold text-gradient-water"
                      style={{ fontFamily: 'var(--font-outfit)' }}
                    >
                    ...
                    <p
                      ...
                      style={{ color: 'rgba(224,242,254,0.6)', fontFamily: 'var(--font-outfit)' }}
                    >
                      {stat.label}
                    </p>
                  </div>
